...
Week 4 started the topic of classification and touched on the k-NN classifier, Bayes classifier as the optimal classifier (the main idea of the week really) before moving onto linear classification and the perceptron algorithm. I felt (again) that some of the intuition as to what we were trying to achieve was lost in a sea of dense notation so I hope I can simplify it a little below. The main ideas:
