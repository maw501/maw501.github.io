...
The start of the derivation from this angle can seem like a little bit like a leap of faith without the appropriate context.
...
&=\mathbb{E}_{z \sim Q}\left[\ln \frac{P(X | z) P(z)}{P(z | X)}\right]  &\text{(Baye's rule)} \\[5pt]
